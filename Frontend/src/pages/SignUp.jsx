    ...
    <div className="flex min-h-screen items-center justify-center bg-black px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-neutral-800 bg-neutral-900/40 p-8 backdrop-blur-xl shadow-2xl">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-white">Create an account</h2>
          <p className="mt-1 text-sm text-neutral-400">Get started with your free account today</p>
        </div>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <span className="absolute bg-neutral-900/90 px-3 text-xs uppercase text-neutral-500">Or register with</span>
        </div>
